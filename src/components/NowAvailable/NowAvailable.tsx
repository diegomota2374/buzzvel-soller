...
const NowAvailable = () => {
  ...
  return (
    <>
      {/* Configuração do SEO para a página */}
      <NextSeo
        title="Solar Power for Your Home | Now Available"
        description="Get all the solar power you need for your home. Discover the latest solar energy solutions to power your house efficiently and sustainably."
        canonical={urlDomain}
        openGraph={{
          url: urlDomain,
          title: "Solar Power for Your Home | Now Available",
          description:
            "Get all the solar power you need for your home. Discover the latest solar energy solutions to power your house efficiently and sustainably.",
