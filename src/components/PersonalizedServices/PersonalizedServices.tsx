...
const PersonalizedServices = () => {
  ...
  return (
    <>
      {/* Configuração de SEO */}
      <NextSeo
        title="Personalized Solar Services | Customized Energy Solutions"
        description="Discover our personalized solar energy services tailored to meet your specific needs. Efficient, sustainable, and cost-effective solutions."
        canonical={urlDomain}
        openGraph={{
          url: urlDomain,
          title: "Personalized Solar Services | Customized Energy Solutions",
          description:
            "Discover our personalized solar energy services tailored to meet your specific needs. Efficient, sustainable, and cost-effective solutions.",
