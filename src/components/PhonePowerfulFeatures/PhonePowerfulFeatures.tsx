    ...
    <div className="relative flex items-center justify-center py-10">
      ...
      <div className="w-[220px] h-[485.43px] bg-[#E0F2FE] border-4 border-white rounded-3xl shadow-lg z-[2] p-6">
        <div className="relative">
          <div className="relative bg-white w-full h-[90px] rounded-lg mt-5 overflow-hidden">
            <div className="absolute w-[60.78px] h-[60.78px] top-[48.91px] left-[125.63px] bg-[#FBBF24] rounded-full "></div>
            <div className="absolute bg-white w-[65.08px] h-[65.08px] top-[16px] right-[10px] border-4 border-[#E0F2FE] rounded-full "></div>
            <div className="absolute bg-[#BAE6FD] w-[110.63px] h-[105.6px] -top-[55px] -left-[55px] -rotate-45"></div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start justify-start gap-2 pt-5">
          <div className="flex items-center gap-1">
            ...
            <FaRegHeart className="text-white ml-6" size={20} />
          </div>
        ...
        <div className="flex items-center  justify-between py-5 relative mt-20">
          <div
